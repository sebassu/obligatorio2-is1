...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mnuPartidaNueva = new javax.swing.JMenuItem();
        mnuJugadorNuevo = new javax.swing.JMenuItem();
        mnuJugadorLista = new javax.swing.JMenuItem();
        ...
        mnuPartidaNueva.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F2, 0));
        mnuPartidaNueva.setText("Registrar Carné");
        mnuPartidaNueva.setToolTipText("Crear un juego nuevo");
        mnuPartidaNueva.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuPartidaNuevaActionPerformed(evt);
            }
        });
        jMenu1.add(mnuPartidaNueva);

        mnuJugadorNuevo.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F3, 0));
        mnuJugadorNuevo.setText("Modificar Registro");
        mnuJugadorNuevo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuJugadorNuevoActionPerformed(evt);
            }
        });
        jMenu1.add(mnuJugadorNuevo);

        mnuJugadorLista.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F4, 0));
        mnuJugadorLista.setText("Eliminar Carné");
        mnuJugadorLista.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuJugadorListaActionPerformed(evt);
            }
        });
        jMenu1.add(mnuJugadorLista);
    ...
    private void mnuJugadorNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuJugadorNuevoActionPerformed

    }//GEN-LAST:event_mnuJugadorNuevoActionPerformed

    private void mnuJugadorListaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuJugadorListaActionPerformed

    }//GEN-LAST:event_mnuJugadorListaActionPerformed

    private void mnuPartidaNuevaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuPartidaNuevaActionPerformed
    ...
    }//GEN-LAST:event_mnuPartidaNuevaActionPerformed
    ...
    private javax.swing.JMenuItem mnuJugadorLista;
    private javax.swing.JMenuItem mnuJugadorNuevo;
    private javax.swing.JMenuItem mnuPartidaNueva;
